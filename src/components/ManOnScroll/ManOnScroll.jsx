    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4 z-[5] relative ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          {/* Step 1 */}
          <div className="relative bg-[#FAED00] p-8  border border-black rounded-lg  shadow-custom hover:scale-[1.01] hover:shadow-none hover:cursor-pointer transition-all duration-300">
