...
const PrivacyPolicy = () => {
  return (
    <div className=" text-gray-800 sm:p-10 sm:px-40 m-6 ">
      <h1 className="text-3xl font-mono font-bold pb-6 sm:text-center">
        Privacy Policy
      </h1>

      <p className="pb-6 font-sans font-medium text-lg">
        ...
        <a
          ...
          className="text-[#FAED00] underline hover:text-blue-800"
        >
      ...
      <h2 className="text-2xl font-mono font-bold pb-4">
      ...
      <ul className="list-disc pl-5 font-sans font-medium text-lg pb-6">
      ...
      <h2 className="text-2xl font-mono font-bold pb-4">Data Retention</h2>
      ...
      <h2 className="text-2xl font-mono font-bold pb-4">Changes</h2>
      ...
      <h2 className="text-2xl font-mono font-bold pb-4">Contact Us</h2>
